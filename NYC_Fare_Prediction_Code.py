...
results = pd.DataFrame({
    ...
    'MSE': [decision_tree_reg_mse, random_forest_reg_mse, gradient_boost_reg_mse, xgb_reg_mse],
    'MAE': [decision_tree_reg_mae, random_forest_reg_mae, gradient_boost_reg_mae, xgb_reg_mae],
    'R2 Score': [decision_tree_reg_r2, random_forest_reg_r2, gradient_boost_reg_r2, xgb_reg_r2]
})

# Print the results
print(results)

#Best Performing Algorithm as per derived metrics is a tight competition between the Random Forest and XGBoost Algorithm. Lets see the cross validated metrics optimizing for MAE
...
grid_search = GridSearchCV(xgboost, param_grid, scoring='neg_mean_squared_error', cv=5)
